  ...
  return (
    <div className="flex h-screen bg-gray-50">
        ...
        <div className="h-full flex flex-col">
          ...
          >
            <motion.h2
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className={`text-2xl font-bold text-brand-blue ${!isExpanded && "hidden"
                }`}
            >
              Dashboard
            </motion.h2>
              ...
              {sidebarLinks.map((link, index) => {
                ...
                return (
                  ...
                  >
                    <motion.a
                      href={link.path}
                      className={`flex items-center space-x-3 p-3 rounded-lg relative group ${isActive
      ...
      <motion.main
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className={`h-auto flex-1 transition-all duration-300 ${!isExpanded ? "ml-20" : "ml-64"
          } mt-6`}
      >
